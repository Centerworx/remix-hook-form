...
- `shouldResetActionData`: if set to false useActionData from remix will return to it's default behavior and re-add server errors on each re-render. `Default: true`
